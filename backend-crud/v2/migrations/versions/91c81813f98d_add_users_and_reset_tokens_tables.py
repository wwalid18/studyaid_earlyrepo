"""Add users and reset_tokens tables

Revision ID: 91c81813f98d
Revises: 
Create Date: 2025-05-22 12:52:40.784846
...
def upgrade():
    ...
    sa.Column('quiz_text', sa.JSON(), nullable=False),
    sa.Column('timestamp', sa.DateTime(), nullable=False),
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
